...
<title>500 — خطأ داخلي | إجلال</title>
...
<script>document.addEventListener('DOMContentLoaded',function(){document.getElementById('reloadBtn')?.addEventListener('click',function(){location.reload()})});</script>
</head>
<body>
...
<h1>خطأ داخلي</h1>
<p>عذراً، حدث خطأ غير متوقع.<br>فريق التقنية لدينا تم إشعاره تلقائياً وسنعمل على إصلاحه في أقرب وقت.</p>
<div class="error-actions">
<a href="{{ url('/') }}" class="btn btn-primary"><span>←</span> العودة إلى الرئيسية</a>
<button id="reloadBtn" class="btn btn-secondary">محاولة إعادة التحميل</button>
</div>
</div>
</body>
</html>