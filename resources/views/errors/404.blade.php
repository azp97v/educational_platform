...
<title>404 — الصفحة غير موجودة | إجلال</title>
...
<p>عذراً، الصفحة التي تبحث عنها غير موجودة أو تم نقلها.<br>قد يكون الرابط غير صحيح أو الصفحة قد حُذفت.</p>
<div class="error-actions">
<a href="{{ url('/') }}" class="btn btn-primary"><span>←</span> العودة إلى الرئيسية</a>
@auth<a href="{{ url()->previous() !== url()->current() ? url()->previous() : url('/') }}" class="btn btn-secondary">العودة للصفحة السابقة</a>@endauth
</div>
</div>
</body>
</html>