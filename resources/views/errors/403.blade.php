...
<title>403 — غير مصرح | إجلال</title>
...
<h1>غير مصرح</h1>
<p>عذراً، لا تملك الصلاحية الكافية للوصول إلى هذه الصفحة.<br>إذا كنت تعتقد أن هذا خطأ، يرجى التواصل مع الدعم الفني.</p>
<div class="error-actions">
<a href="{{ url('/') }}" class="btn btn-primary"><span>←</span> العودة إلى الرئيسية</a>
@auth<a href="{{ url()->previous() !== url()->current() ? url()->previous() : url('/') }}" class="btn btn-secondary">محاولة العودة</a>@endauth
</div>
</div>
</body>
</html>