...
<title>419 — انتهت الجلسة | إجلال</title>
...
<h1>انتهت الجلسة</h1>
<p>انتهت صلاحية جلستك بسبب عدم النشاط.<br>لا تقلق — كل بياناتك آمنة. يرجى تسجيل الدخول مرة أخرى للمتابعة.</p>
<div class="error-actions">
<a href="{{ route('login') }}" class="btn btn-primary"><span>←</span> تسجيل الدخول</a>
<a href="{{ url('/') }}" class="btn btn-secondary">العودة إلى الرئيسية</a>
</div>
</div>
</body>
</html>